...
- [app/backend-azure-functions.bicep](./infra/app/backend-azure-functions.bicep) - Azure Container Apps resources to host the 'backend-azure-functions' service.
- [app/frontend-angular.bicep](./infra/app/frontend-angular.bicep) - Azure Container Apps resources to host the 'frontend-angular' service.
